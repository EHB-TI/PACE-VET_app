...
/// Describes how a review will be returned by the API
///
/// Properties:
/// * [comment] - An optional comment by the reviewer on why a certain state was assigned
/// * [competence]
/// * [id] - The unique identifier of this review
/// * [state]
@BuiltValue()
abstract class Review implements Built<Review, ReviewBuilder> {
  /// An optional comment by the reviewer on why a certain state was assigned
  @BuiltValueField(wireName: r'comment')
  String? get comment;

  @BuiltValueField(wireName: r'competence')
...
class _$ReviewSerializer implements PrimitiveSerializer<Review> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.competence != null) {
      ...
      yield serializers.serialize(
        object.competence,
        specifiedType: const FullType(Competence),
      );
    }
    if (object.id != null) {
      yield r'id';
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'competence':
          ...
          result.competence.replace(valueDes);
          break;
        case r'id':
          final valueDes = serializers.deserialize(
            value,
