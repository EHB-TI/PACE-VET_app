...
class AuthApi {
  ...
  ///
  /// Parameters:
  /// * [token] - The accept token of the mentor invite
  ...
  Future<Response<String>> paceVetWebApiV1AccountsControllerAcceptMentorInvite({
    ...
    final _path = r'/api/v1/user/mentors/accept-invite';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<User>>> paceVetWebApiV1AccountsControllerAssessors({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/user/assessors';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> paceVetWebApiV1AccountsControllerGetUser({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [String] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> paceVetWebApiV1AccountsControllerInviteMentor({
    ...
    final _path = r'/api/v1/user/mentors';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(MentorRequest);
      _bodyData = mentorRequest == null
          ? null
          : _serializers.serialize(mentorRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LoginResponse>> paceVetWebApiV1AccountsControllerLogin({
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<User>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<User>>> paceVetWebApiV1AccountsControllerMentors({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenPairResponse>> paceVetWebApiV1AccountsControllerMfa({
    ...
    try {
      const _type = FullType(MfaRequest);
      _bodyData = mfaRequest == null
          ? null
          : _serializers.serialize(mfaRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [TokenPairResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenPairResponse>> paceVetWebApiV1AccountsControllerRefresh({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  ///
  /// Parameters:
  /// * [registerRequest] - User parameters
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> paceVetWebApiV1AccountsControllerRegister({
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> paceVetWebApiV1AccountsControllerUpdateUser({
...
// still adding stuff
  Future<Response<String>> paceVetWebApiV1AccountsControllerDeleteUser({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
